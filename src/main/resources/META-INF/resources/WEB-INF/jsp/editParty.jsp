...
<head>
    ...
    <title>Swaraj Traders - Edit Party</title>
...
<body>
    ...
    <div class="container">
        ...
        <div class="form-section">
            ...
            <form action="/swarajtraders/editParty" method="post" class="needs-validation" novalidate>
                <!-- CSRF Token -->
                <input type="hidden" name="${_csrf.parameterName}" value="${_csrf.token}"/>
                
                <!-- Hidden Party ID for editing -->
                ...
                <a href="/swarajtraders/parties" class="btn btn-outline-danger" style="margin-left: 1rem;">
                    <i class="fas fa-arrow-left"></i> Back to Party List
                </a>
